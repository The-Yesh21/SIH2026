    ...
    <div className="space-y-6">
      ...
      {activeStep === "FLEET_SELECT" ? (
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-100 pb-5">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Select any train below to open its live movements, dynamic ETA predictions, and bottleneck sector forensics.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 font-mono text-xs">
              ...
              <div className="px-3 py-1.5 rounded-xl bg-blue-50 border border-blue-200 text-blue-700">
                Running: <strong>{runningCount}</strong>
              </div>
              <div className="px-3 py-1.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-700">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-sans"
              />
            </div>
              ...
              return (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 font-mono bg-slate-50 p-2 rounded-xl border border-slate-100">
                      <div>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-blue-600 font-bold group-hover:text-blue-700">
                    <span>Open Live Movements &amp; ETA Forensics</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-mono font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
          ...
          {/* 2-Column Split: [Recent Movements & Track Spine] | [Dynamic ETA & Pain Points] */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            
            {/* LEFT COLUMN (6 Cols): Recent Movements & Station Progression Spine */}
            <div className="lg:col-span-6 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-5">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-4 text-white shadow-md space-y-3">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono text-blue-100 text-[11px]">GPS / Axle Counter Verified</span>
                </div>
            ...
            {/* RIGHT COLUMN (6 Cols): Dynamic ETA & Pain Points */}
