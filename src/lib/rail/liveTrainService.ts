...
export const RAILWAY_TRAIN_DATABASE: Record<string, { name: string; type: RollingStockType; source: string; dest: string; stops: string[]; dep: string; arr: string; mps: number }> = {
  ...
  "16586": {
    name: "MRDW - SMVB Express",
    type: "EXPRESS",
    source: "MYS (Mysuru Jn)",
    dest: "SMVB (Bengaluru)",
    stops: ["MYS", "PANP", "MYA", "MAD", "RMGM", "BID", "KGI", "SBC"],
    dep: "03:45",
    arr: "06:25",
    mps: 110,
  },
  "16232": {
    name: "Mysuru - Mayiladuturai Express",
    type: "EXPRESS",
    source: "MYS (Mysuru Jn)",
    dest: "MV (Mayiladuturai Jn)",
    stops: ["MYS", "MYA", "MAD", "KGI", "SBC"],
    dep: "16:15",
    arr: "18:50",
    mps: 110,
  },
  "16236": {
    name: "Mysuru - Tuticorin Express",
    type: "EXPRESS",
    source: "MYS (Mysuru Jn)",
    dest: "TN (Tuticorin)",
  ...
  "BOXN-58219": {
    ...
    type: "FREIGHT_BOXN",
    source: "MYS Goods Yard",
    dest: "Whitefield Goods Terminal",
    stops: ["MYS", "SBC"],
    dep: "01:00",
    arr: "04:30",
    mps: 75,
